    ...
    shader.fragmentShader =
      ...
      shader.fragmentShader.replace(
        ...
        /* glsl */ `#include <emissivemap_fragment>
        {
          ...
          // White print stays legible on the clear-tape version. Black print
          // contributes no light, so the silver version remains unchanged.
          totalEmissiveRadiance += surf.rgb * surfA * 0.55;
